...
# when converted to numeric, TRUE converts to 1, and FALSE converts to 0
d = c(TRUE, FALSE, FALSE, TRUE, FALSE)
d = as.numeric(d)
d

# Converting numeric to logical (1 or nay number other than 0
# converts to TRUE, and 0 converts to FALSE)
d
class(d)
d = as.logical(d)
d
...
my_seq = c(1:50, 81, 99, 88, 77, 71, 61, 92, 97)
my_seq
